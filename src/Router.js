...
const StockManagement = lazy(() =>
  import("./views/apps/stockmanagement/StockManagement")
);
...
const LubricantSales = lazy(() =>
  import("./views/apps/shiftmanagement/LubricantSales")
);
const Attendance = lazy(() =>
  import("./views/apps/shiftmanagement/Attendance")
);
const FacilityManagement = lazy(() =>
  import("./views/apps/facilitymanagement/FacilityManagement")
);
...
const training = lazy(() => import("./views/apps/training/Training"));
const roForm = lazy(() => import("./views/apps/ro-configuration/RoForm"));
const shiftManagement = lazy(() =>
  import("./views/apps/shiftmanagement/ShiftManagement")
);
const shiftDealerTable = lazy(() =>
  import("./views/apps/shiftmanagement/ShiftDealerTable")
);
const roConfiguration = lazy(() =>
  import("./views/apps/ro-configuration/RoConfiguration")
);
const staffManagement = lazy(() =>
  import("./views/apps/staffmanagement/StaffManagement")
);
const staffManagementDealer = lazy(() =>
  import("./views/apps/staffmanagement/StaffManagementDealer")
);
const staffForm = lazy(() => import("./views/apps/staffmanagement/StaffForm"));
const cashDealerTable = lazy(() =>
  import("./views/apps/cashmanagement/CashDealerTable")
);
const cashManagement = lazy(() =>
  import("./views/apps/cashmanagement/CashManagement")
);
    ...
    return (
      ...
      <Router history={history}>
        <Switch>
          ...
          />
          <AppRoute path="/StockManagement" component={StockManagement} />
          <AppRoute path="/FuelStock" component={FuelStock} />
          <AppRoute path="/LubeStock" component={LubeStock} />
          <AppRoute path="/LubricantSales" component={LubricantSales} />
          <AppRoute path="/Attendance" component={Attendance} />
          <AppRoute path="/FacilityManagement" component={FacilityManagement} />
          <AppRoute path="/MpdManagement" component={MpdManagement} />
          <AppRoute
            path="/email"
            exact
          ...
          {/* my componet */}
          <AppRoute
            path="/app/shiftManagement/shiftManagement"
            component={shiftManagement}
          />
          <AppRoute
            path="/app/shiftManagement/shiftDealerTable"
            component={shiftDealerTable}
          />
          <AppRoute
            path="/app/ro-configuration/roConfiguration"
            component={roConfiguration}
          />
          <AppRoute path="/app/ro-configuration/roForm" component={roForm} />
          <AppRoute
            path="/app/staffManagement/staffManagement"
            component={staffManagement}
          />
          <AppRoute
            path="/app/staffManagement/staffManagementDealer"
            component={staffManagementDealer}
          />
          <AppRoute
            path="/app/staffManagement/staffForm"
            component={staffForm}
          />
          <AppRoute
            path="/app/cashManagement/cashManagement"
          ...
          <AppRoute path="/app/training/Training" component={training} />
