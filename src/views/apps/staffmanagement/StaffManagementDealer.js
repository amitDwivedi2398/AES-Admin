...
class StaffManagementDealer extends React.Component {
  state = {
    rowData: null,
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <Breadcrumbs
          breadCrumbTitle="staff Management"
          breadCrumbParent="Forms & Tables"
          breadCrumbActive="staff Management"
        />
...
export default StaffManagementDealer;
